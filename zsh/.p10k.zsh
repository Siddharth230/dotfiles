# Generated by Powerlevel10k configuration wizard on 2025-06-27 at 19:14 IST.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # You can find backup on Gmail
  typeset -g POWERLEVEL9K_DIR_SHOW_FULL_PATH=false
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=0  # Always shorten to minimum
